...
public class DataLoader {
    ...
    public static void createTable(Connection connection) throws SQLException {
        ...
        if (connection != null) {
            ...
            statement.execute("create table Clients (Client_Id INT UNSIGNED NOT NULL AUTO_INCREMENT,PRIMARY KEY (Client_Id), First_Name varchar (25), Last_Name varchar (25), " +
...

        {
            ...
            PreparedStatement preparedStatement = dataBaseConnection.prepareStatement(insert);
...

                {
                    ...
                    if(count==200 || i== clientList.size()-1) {
